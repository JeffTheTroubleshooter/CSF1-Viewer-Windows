...
Public host tool for JCkernel CSF1 disks. Sister editions: Linux and macOS.

Public `CSF1-Viewer-Windows` 0.3.7 launchers expect these host tools next to `CSF1-Viewer.bat`. A fresh clone needs `csf1_core.py`, `csf1_viewer.py`, and `qcow2io.py` on `main` (inspect-rb trio only — not the JCKernel).
